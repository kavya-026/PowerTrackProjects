...
Name:Kavyshree.K
Date:20/07/2026
Description: The Source to HTML project reads a C source file, identifies different lexical elements 
such as keywords, comments, strings, numbers, and preprocessor directives, and generates an HTML file with syntax highlighting */
#include <stdio.h>
